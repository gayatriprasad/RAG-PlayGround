...
def get_tracer(use_langfuse: bool = True) -> BaseTracer:
    """
    Get appropriate tracer based on configuration.
    
    Args:
        use_langfuse: Try to use Langfuse if available and configured
        
    Returns:
        BaseTracer instance (LangfuseTracer or JSONLTracer)
    """
